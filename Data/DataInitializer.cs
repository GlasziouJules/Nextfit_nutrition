...
public class DataInitializer
{
    ...
    private async Task SeedUtilisateurs()
    {
        _ctx.Utilisateurs.AddRange(
            new Utilisateur
            {
                ...
                TypeAbonnement = Utilisateur.TypeAbonnement.VIP
            },
            new Utilisateur
            {
                ...
                TypeAbonnement = Utilisateur.TypeAbonnement.PREMIUM
            }
        );
        await _ctx.SaveChangesAsync();
    }
    ...
    private Task SeedPlansRepas()
    {
        ...
        var priseMasse = new PlanRepas
        {
            ...
            Objectif = QuestionnaireAlimentaire.ObjectifSportif.PRISE_DE_MASSE,
            Preference = QuestionnaireAlimentaire.PreferenceAlimentaire.OMNIVORE,
            CaloriesTotalesKcal = 2800,
            ProteinesG = 200, GlucidesG = 310, LipidesG = 75, FibresG = 35,
            Repas = new List<Repas>
            {
                new() {
                    TypeRepas = Repas.TypeRepas.PETIT_DEJEUNER,
                ...
                new() {
                    TypeRepas = Repas.TypeRepas.COLLATION_MATIN,
                ...
                new() {
                    TypeRepas = Repas.TypeRepas.DEJEUNER,
                ...
                new() {
                    TypeRepas = Repas.TypeRepas.COLLATION_APRES_MIDI,
                ...
                new() {
                    TypeRepas = Repas.TypeRepas.DINER,
        ...
        var seche = new PlanRepas
        {
            ...
            Objectif = QuestionnaireAlimentaire.ObjectifSportif.SECHE,
            Preference = QuestionnaireAlimentaire.PreferenceAlimentaire.OMNIVORE,
        ...
        var equilibre = new PlanRepas
        {
            ...
            Objectif = QuestionnaireAlimentaire.ObjectifSportif.EQUILIBRE,
            Preference = QuestionnaireAlimentaire.PreferenceAlimentaire.VEGETARIEN,
        ...
        var veganMasse = new PlanRepas
        {
            ...
            Objectif = QuestionnaireAlimentaire.ObjectifSportif.PRISE_DE_MASSE,
            Preference = QuestionnaireAlimentaire.PreferenceAlimentaire.VEGAN,
    ...
    private Task SeedArticles()
    {
        _ctx.Articles.AddRange(
            new ArticleNutrition
            {
                ...
                TypeContenu = ArticleNutrition.TypeContenu.ARTICLE,
                Categorie = ArticleNutrition.CategorieNutrition.HYDRATATION,
            ...
            new ArticleNutrition
            {
                ...
                TypeContenu = ArticleNutrition.TypeContenu.ARTICLE,
                Categorie = ArticleNutrition.CategorieNutrition.COMPLEMENTS_ALIMENTAIRES,
            ...
            new ArticleNutrition
            {
                ...
                TypeContenu = ArticleNutrition.TypeContenu.VIDEO,
                Categorie = ArticleNutrition.CategorieNutrition.COMPLEMENTS_ALIMENTAIRES,
                Auteur = "NextFit TV",
            ...
            new ArticleNutrition
            {
                ...
                TypeContenu = ArticleNutrition.TypeContenu.ARTICLE,
                Categorie = ArticleNutrition.CategorieNutrition.FIBRES,
                Auteur = "Dr. Marie Dupont, Diététicienne agréée",
            ...
            new ArticleNutrition
            {
                ...
                TypeContenu = ArticleNutrition.TypeContenu.ARTICLE,
                Categorie = ArticleNutrition.CategorieNutrition.GESTION_FRINGALES,
                Auteur = "Coach Nutrition NextFit",
            ...
            new ArticleNutrition
            {
                ...
                TypeContenu = ArticleNutrition.TypeContenu.ARTICLE,
                Categorie = ArticleNutrition.CategorieNutrition.PROTEINES,
                Auteur = "Dr. Marie Dupont, Diététicienne agréée",
            ...
            new ArticleNutrition
            {
                ...
                TypeContenu = ArticleNutrition.TypeContenu.ARTICLE,
                Categorie = ArticleNutrition.CategorieNutrition.AVANT_SPORT,
                Auteur = "Coach Nutrition NextFit",
